...
static char rcsid[] = "$Header: /cvsroot/bfree-info/B-Free/Program/PC9801/src/kernel/itron-3.0/common/syscall.c,v 1.1 2011/12/27 17:13:36 liu1 Exp $";
 ...
 */
   ...
   */
#ifdef notdef  
  printf ("%s, %d, syscall: called. (errno = %d)\n", 
