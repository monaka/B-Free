 ...
 *
 * $Header: /cvsroot/bfree-info/B-Free/Program/btron-pc/boot/2nd-opts/fd.h,v 1.1 2011/12/27 17:13:35 liu1 Exp $
 *
 * $Log: fd.h,v $
...
extern int	fd_seek (BYTE drive, int cylinder, int motor);
