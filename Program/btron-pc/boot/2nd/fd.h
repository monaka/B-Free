 ...
 * FD §Œ•÷•Ì•√•Ø•µ•§•∫§Ú 512 •–•§•»§´§È 1024 •–•§•»§À —ππ
 *
 * Revision 1.3  1996/07/06  13:09:14  night
 * Floppy disk ¥ÿœ¢§ŒƒÍµ¡§Ú PC ∏ﬂ¥πµ°Õ—§À —ππ
 *
 * Revision 1.2  1996/06/11  16:41:15  night
 * FD §Œ•œ°º•…•¶•ß•¢§À¥ÿ∑∏§∑§øƒÍøÙ§Ú IBM-PC §ÀπÁ§Ô§ª —ππ§∑§ø°£
 *
...
#define FDC_EXTERNAL	0xBE	/* ≥∞…Ù•Ï•∏•π•ø§ÿ§Œ•¢•…•Ï•π */
...
#define HD_LENCODE	2
#ifdef notdef
#define HD_GAP		0x2A		/* HD §ŒæÏπÁ§Œ GAP3 §Œ√Õ */
#else
#define HD_GAP		0x1B		/* HD §ŒæÏπÁ§Œ GAP3 §Œ√Õ */
#endif
#define HD_DTL		0xff
...
#define HD_LENGTH	1024
#define HD_LENCODE	3
#define HD_GAP		0x35		/* HD §ŒæÏπÁ§Œ GAP3 §Œ√Õ */
#define HD_DTL		0xff
...
#define HD_LENCODE	2
#define HD_GAP		0x1B		/* HC §ŒæÏπÁ§Œ GAP3 §Œ√Õ */
#define HD_DTL		0xff
