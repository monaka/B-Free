 ...
 * Author: Jgen E. Fischer, fischer@et-inf.fho-emden.de
 * Copyright 1993, 1994, 1995, 1996 Jgen E. Fischer
 *
 *
 ...
 *
 *
 * $Id: aha152x.c,v 1.1 2011/12/27 17:13:35 liu1 Exp $
 *
 * $Log: aha152x.c,v $
 * Revision 1.1  2011/12/27 17:13:35  liu1
 * Initial Version.
 *
 * Revision 1.6  2000-01-25 16:05:49  kishida0
 * add file and modif
 *
 * Revision 1.5  1999/12/18 15:24:01  kishida0
 * linuxのソースを追加した
 *
 * Revision 1.4  1999/12/09 17:13:10  kishida0
 * *** empty log message ***
 *
 * Revision 1.3  1999/12/02 16:02:31  kishida0
 * Here is start.
 *
 * Revision 1.2  1999/07/06 13:49:25  kishida0
 * for debug
 *
 * Revision 1.1  1998/05/26 13:51:04  night
 * Linux からソースを移動。
 * Linux kernel のバージョンは、2.0.33。
 *
...
int aha152x_detect(Scsi_Host_Template * tpnt)
{
  ...
  for(i=0; i<setup_count; i++) {
    ...
    the_time=100;
    while(!HOSTDATA(shpnt)->swint && 0<the_time){
      barrier();
      dly_tsk(1);
      the_time--;
    }
...
int get_ports(struct Scsi_Host *shpnt, char *pos)
{
  char *start = pos;
  int s;
