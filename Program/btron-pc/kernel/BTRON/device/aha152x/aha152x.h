...
/*
 * $Id: aha152x.h,v 1.1 2011/12/27 17:13:35 liu1 Exp $
 */
...
#if 0
int aha152x_detect(Scsi_Host_Template *t);
int aha152x_command(Scsi_Cmnd *c);
int aha152x_queue(Scsi_Cmnd *c, void (*done)(Scsi_Cmnd *c));
int aha152x_abort(Scsi_Cmnd *c);
int aha152x_reset(Scsi_Cmnd *c, unsigned int id);
int aha152x_biosparam(Disk *n, kdev_t d, int *id);
