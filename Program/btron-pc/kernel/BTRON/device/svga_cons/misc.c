...
*/
/* @(#)$Header: /cvsroot/bfree-info/B-Free/Program/btron-pc/kernel/BTRON/device/svga_cons/misc.c,v 1.1 2011/12/27 17:13:35 liu1 Exp $ */

static char rcsid[] = "@(#)$Header: /cvsroot/bfree-info/B-Free/Program/btron-pc/kernel/BTRON/device/svga_cons/misc.c,v 1.1 2011/12/27 17:13:35 liu1 Exp $";
 ...
 * *** empty log message ***
 *
 * Revision 1.1  1999/04/13 15:34:42  kishida0
 * for debug use
 *
...
init_log (void)
{
  if (find_port (SVGA_CONS_DRIVER, &log_port) != E_PORT_OK)
    {
