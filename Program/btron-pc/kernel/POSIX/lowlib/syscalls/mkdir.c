...
*/
/* $Header: /cvsroot/bfree-info/B-Free/Program/btron-pc/kernel/POSIX/lowlib/syscalls/mkdir.c,v 1.1 2011/12/27 17:13:35 liu1 Exp $ */
static char rcsid[] = "@(#)$Header: /cvsroot/bfree-info/B-Free/Program/btron-pc/kernel/POSIX/lowlib/syscalls/mkdir.c,v 1.1 2011/12/27 17:13:35 liu1 Exp $";
...
psys_mkdir (void *argp)
{
  ...
  error = _make_connection(PSC_MKDIR, &req, &res);
  if (error != E_OK)
    {
      /* What should I do? */
    }
